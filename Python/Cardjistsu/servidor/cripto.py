...
if __name__ == "__main__":
    '''
    El programa me pasa el byte b'x09' a b'\t', 
    por lo que para que funcione voy a cambiar
    el byte \x09 a \t en esta parte
    '''
    msg_original = bytearray(b'\x05\x08\x03\x02\x04\x03\x05\t\x05\t\x01')
    msg_esperado = bytearray(b'\x01\x05\x02\x05\t\x03\x03\x05\x08\x04\t\x01')
